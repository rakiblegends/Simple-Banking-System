...
class Program
{
    ...
    static Dictionary<int,BankAccount> accounts1 = new Dictionary<int, BankAccount>();
    ...
    static void CreateAccount(int type)
    {
        ...
        if (type==1)
        {
            if (!(accounts.ContainsKey(number)) && !(accounts1.ContainsKey(number)))
            {
    ...
    static void CheckBalance()
    {
        ...
        //{
        //    return accounts1[number].CheckBalance();
        //}
    }
    ...
    static void Deposit()
    {
        ...
        //else if (accounts1.ContainsKey(number))
        //{
        //    Console.WriteLine("Deposited $"+amount+" .New Balance $"+CheckBalance(number));
